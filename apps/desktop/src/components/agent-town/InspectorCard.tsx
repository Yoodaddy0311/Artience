...
const STATE_BG: Record<AgentState, string> = {
    ...
    READING: 'bg-blue-100',
    TYPING: 'bg-orange-100',
    WRITING: 'bg-violet-100',
    SLEEPING: 'bg-gray-100',
};
            ...
            <div className="px-4 py-3 border-b border-gray-200">
                ...
                <div className="flex items-center gap-2">
                    <span
                        ...
                        style={{
                            backgroundColor:
                                STATE_COLORS_CSS[agent.state] ||
                                STATE_COLORS_CSS.IDLE,
                        }}
                    />
                    <span
                        className={`text-sm font-black px-2.5 py-1 rounded-md border-2 border-black ${STATE_BG[agent.state]} shadow-[1px_1px_0_0_#000]`}
                    >
