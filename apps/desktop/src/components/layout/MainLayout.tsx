...
class AgentTownBoundary extends React.Component<
...
type StudioTab = 'inbox' | 'builder' | 'history';

const STUDIO_TABS: { key: StudioTab; icon: React.ReactNode; label: string }[] =
    [
        {
            key: 'inbox',
            icon: <Inbox className="w-3.5 h-3.5 inline-block" />,
            label: 'Inbox',
        },
        {
            key: 'builder',
            icon: <Package className="w-3.5 h-3.5 inline-block" />,
            label: 'Builder',
        },
        {
            key: 'history',
            icon: <Clock className="w-3.5 h-3.5 inline-block" />,
            label: 'History',
        },
    ];
            ...
            <div className="flex-1 relative bg-cream-100">
                ...
                <div className="flex flex-col h-full">
                    ...
                    <div className="relative flex-1">
                        {/* Town view: always block but hidden behind Studio tools when studio is active */}
                        <div
                        ...
                        {/* Studio view: overlay structure */}
                        <div
                            className="absolute inset-0 pt-4 pb-32 px-4 z-20 overflow-hidden pointer-events-none"
                            style={{
                                display:
                                    activeView === 'studio' ? 'flex' : 'none',
                            }}
                        >
                            {/* Left: Studio Tools Panel */}
                            <div className="w-full max-w-sm flex-shrink-0 flex flex-col bg-white rounded-2xl shadow-xl border-4 border-black overflow-hidden pointer-events-auto">
                                <div
                                    className="flex border-b-2 border-black bg-gray-50"
                                    role="tablist"
                                        ...
                                        <>
                                            <div className="flex items-center bg-white border-4 border-black shadow-[6px_6px_0_0_#000] rounded-2xl p-2 hover:-translate-y-1 hover:shadow-[8px_8px_0_0_#000] transition-all">
                                                <div className="w-10 h-10 bg-[#FFD100] border-4 border-black rounded-lg flex items-center justify-center rotate-3">
                                                    <span className="font-bold text-black text-[20px] leading-[1.48]">
                                                        W
                                                    </span>
                                                </div>
                            ...
                            {SHOW_GAMIFICATION && activeView !== 'studio' && (
                                <div className="absolute bottom-6 right-6 flex gap-6 pointer-events-auto items-end">
                                    <button
                                        ...
                                        className="group flex flex-col items-center gap-3 hover:-translate-y-2 transition-transform"
                                    >
                                        <div className="w-[68px] h-[68px] bg-white border-4 border-black shadow-[4px_4px_0_0_#000] rounded-2xl flex items-center justify-center overflow-hidden transition-all group-active:translate-y-1 group-active:shadow-none">
                                            <img
                                                src={assetPath(
                                                    '/assets/ui/management.png',
                                                )}
                                                alt="관리"
                                                className="w-[48px] h-[48px] object-contain"
                                            />
                                        </div>
                                        <span className="bg-white text-black text-[12px] leading-[1.48] font-bold px-4 py-1.5 border-4 border-black shadow-[2px_2px_0_0_#000] rounded-lg">
                                            팀 관리
                                        </span>
                                    </button>
                                    <button
                                    ...
                                    >
                                        ...
                                        <span className="bg-[#E8DAFF] text-black text-[12px] leading-[1.48] font-bold px-4 py-1.5 border-4 border-black shadow-[2px_2px_0_0_#000] rounded-lg">
                                            업적도감
                                        </span>
                                    </button>
                                    <button
                                    ...
                                    >
                                        ...
                                        <span className="bg-[#9DE5DC] text-black text-[12px] leading-[1.48] font-bold px-4 py-1.5 border-4 border-black shadow-[2px_2px_0_0_#000] rounded-lg">
                                            스케줄
                                        </span>
                                    </button>
                                    <button
                                    ...
                                    >
                                        ...
                                        <span className="bg-[#FFD100] text-black text-[15px] leading-[1.48] font-bold px-6 py-2 border-4 border-black shadow-[4px_4px_0_0_#000] rounded-lg uppercase tracking-normal">
                                            상점
                                        </span>
                                    </button>
                                </div>
