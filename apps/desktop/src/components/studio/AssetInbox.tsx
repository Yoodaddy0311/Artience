        ...
        <div className="flex flex-col h-full bg-white">
            ...
            <div className="p-4 border-b-2 border-black bg-[#E8DAFF]">
                <h2 className="font-black text-lg text-black flex items-center gap-1.5">
                    <Inbox className="w-5 h-5 inline-block" strokeWidth={2.5} />{' '}
                    Asset Inbox
                </h2>
            ...
            <div
                ...
                className={`m-4 p-8 border-3 border-dashed rounded-xl text-center cursor-pointer transition-all ${
                    isDragging
            ...
            >
                <div className="mb-2">
                    {isDragging ? (
                        <Target
                            className="w-10 h-10 mx-auto text-[#FFD100]"
                            strokeWidth={2.5}
                        />
                    ) : (
                        <FolderOpen
            ...
            <div className="px-4 pb-2 flex gap-2 flex-wrap">
                {['all', 'Theme', 'World', 'Agents', 'Recipes'].map((tag) => (
                    <button
                        ...
                        className={`text-xs font-black px-3 py-1.5 rounded-md border-2 border-black transition-all shadow-[1px_1px_0_0_#000] ${
                            filter === tag
            ...
            <div className="flex-1 overflow-y-auto px-4 pb-4 space-y-2">
                {filteredAssets.length === 0 ? (
                    ...
                    filteredAssets.map((asset) => (
                        <div
                            key={asset.id}
                            className="flex items-start gap-3 p-3 rounded-lg border-2 border-black bg-white shadow-[2px_2px_0_0_#000] hover:shadow-[3px_3px_0_0_#000] transition-all"
                        >
                            {/* Preview */}
